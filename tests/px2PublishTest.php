...
class px2PublishTest extends PHPUnit_Framework_TestCase{
	...
	public function testBefore(){
		...
		$output = $this->helper->passthru( [
			'php',
			__DIR__.'/testdata/pxfw2-original/publish/px2/.px_execute.php' ,
			'/?PX=api.get.version' ,
		] );
		clearstatcache();
	...
	public function testStandardPublishBeforeSitemap(){
		$this->fs->copy(
			__DIR__.'/testdata/pxfw2-original/publish/px2/px-files/config_before_sitemap.php',
			__DIR__.'/testdata/pxfw2-original/publish/px2/px-files/config.php'
		);
		$output = $this->helper->passthru( [
			'php',
			__DIR__.'/testdata/pxfw2-original/standard/.px_execute.php' ,
		...
		$page_src = $this->fs->read_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/sample_pages/page1/template.html' );
		...
		$page_src = $this->fs->read_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/sample_pages/page3/3.html' );
		$this->assertEquals( preg_match( '/'.preg_quote('<!DOCTYPE html>', '/').'/s', $page_src ), 1 );
		$this->assertEquals( preg_match( '/'.preg_quote('<p>このページは『共通点コンテンツからの出力B』から出力されています。</p>', '/').'/s', $page_src ), 1 );

		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/templates.ignore/template.html' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/templates.ignore/template.html.md' ) );

		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/dynamicPath/index.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/dynamicPath/dp_test/index.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/dynamicPath/dp_test/a.html' ) );
		...
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/standard/caches/c/contents/path_files_cache_files/test2/test2.inc' ) );
		...
		// var_dump($fileSrc);
		$this->assertEquals( preg_match( '/'.preg_quote('<pre>'.$this->fs->get_realpath( $this->fs->normalize_path( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/caches/c/contents/path_files_private_cache_files/a.html' ) ), '/').'/s', $fileSrc ), 1 );
		...
		$this->assertEquals( $publish_log[0][7], 'user_agent' );
		$this->assertEquals( $publish_log[0][8], 'proc_microtime' );
		$this->assertNull( @$publish_log[0][9] );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/alert_log.csv' ) );
	...
	public function testStandardPublishBeforeContent(){
		$this->fs->copy(
			__DIR__.'/testdata/pxfw2-original/publish/px2/px-files/config_before_content.php',
			__DIR__.'/testdata/pxfw2-original/publish/px2/px-files/config.php'
		);
		$output = $this->helper->passthru( [
			'php',
	...
	public function testPublishRegion(){
		...
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/templates.ignore/template.html.md' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/contents/path_plugin_files.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/contents/path_files_private_cache.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/contents/get_contents_manifesto.html' ) );
		$this->assertFalse( is_dir( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/contents/path_files_cache_files/test2/' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/contents/path_files_cache.html' ) );
	...
	public function testPublishRegionWildcard(){
		...
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/px2/px-files/_sys/ram/publish/htdocs/region/ignore/test1.html' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/px2/px-files/_sys/ram/publish/htdocs/region/ignore/test1_files/ignored_ext.tmp_ig' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/px2/px-files/_sys/ram/publish/htdocs/region/ignore/test2.html' ) );

		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/region/ignore/index.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/region/ignore/test1.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/region/ignore/test1_files/ignored_ext.tmp_ig' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/region/ignore/test2.html' ) );

		// 後始末
		// $this->assertTrue( false );
		$output = $this->helper->passthru( [
			'php', __DIR__.'/testdata/pxfw2-original/publish/px2/.px_execute.php', '/?PX=clearcache'
		] );
		clearstatcache();
		$this->assertTrue( $this->helper->common_error( $output ) );
		$this->assertTrue( !is_dir( __DIR__.'/testdata/pxfw2-original/publish/px2/caches/p/' ) );
	...
	public function testPublishDirectoryTest(){
		@$this->fs->mkdir_r( __DIR__.'/testdata/pxfw2-original/publish/published/update_sync_test/' );
		@$this->fs->save_file( __DIR__.'/testdata/pxfw2-original/publish/published/update_sync_test/old.html', 'old.html' );
		@$this->fs->rm( __DIR__.'/testdata/pxfw2-original/publish/published/update_sync_test/new.html' );

		// テストデータの操作をテスト
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/update_sync_test/old.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/update_sync_test/old.html' ) );
		...
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/path_ignored/testpage.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/path_ignored/untouchable.html' ) );

		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/px2/files_ignored/index.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/files_ignored/index.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/px2/files_ignored/not_ignored.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/files_ignored/not_ignored.html' ) );

		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/files_ignored_dist_only/test1.txt' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/px2/files_ignored_dist_only/test1.txt' ) );


		// パブリッシュ対象外設定のテスト
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/index.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/not_ignore/index.html' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/ignore/index.html' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/ignore/index_files/no_publish.css' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/ignore/index_files/no_publish.js' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/ignore/index_files/no_publish.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/ext/css.css' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/ext/scss.css' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/ext/scss.css.scss' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/ext/md.html' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/ext/md.html.md' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/no_publish/ext/html.html' ) );

		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/proc_type/ignore.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/proc_type/pass.html' ) );
		$this->assertEquals(
			file_get_contents( __DIR__.'/testdata/pxfw2-original/publish/published/proc_type/pass.html' ),
			file_get_contents( __DIR__.'/testdata/pxfw2-original/publish/px2/proc_type/pass.html' )
		);
	...
	public function testPublishDirectoryMultiRegionTest(){
		@$this->fs->rm( __DIR__.'/testdata/pxfw2-original/publish/published/region/' );

		// テストデータの操作をテスト
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/region/region1/index.html' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/region/region2/index.html' ) );
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/region/region3/index.html' ) );
		...
		$this->assertFalse( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/region/region2/index.html' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/publish/published/region/region3/index.html' ) );
	...
	public function testStandardSingleFile(){
		...
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/htdocs/common/styles/sitemap_loaded.css' ) );
		...
		$this->assertTrue( $this->helper->common_error( $output ) );
		$this->assertTrue( !is_dir( __DIR__.'/testdata/pxfw2-original/standard/caches/p/' ) );
		$this->assertTrue( !is_dir( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/caches/sitemaps/' ) );
	}
	...
	public function testPublishDuringGeneratingSitemapCache(){
		...
		$this->fs->mkdir_r(__DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/caches/sitemaps/');
		$this->fs->save_file(
			__DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/caches/sitemaps/making_sitemap_cache.lock.txt',
			''
		);
		...
		$csv = $this->fs->read_csv( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/publish/alert_log.csv' );
	...
	public function testStandardClearcache(){
		...
		$this->assertTrue( is_dir( __DIR__.'/testdata/pxfw2-original/standard/caches/p/' ) );
		$this->assertTrue( is_dir( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/caches/sitemaps/' ) );
		$this->assertTrue( is_file( __DIR__.'/testdata/pxfw2-original/standard/px-files/_sys/ram/caches/sitemaps/sitemap.array' ) );
		...
		$this->assertTrue( $this->helper->common_error( $output ) );
		$this->assertTrue( !is_dir( __DIR__.'/testdata/pxfw2-original/publish/px2/caches/p/' ) );
		$this->assertTrue( !is_dir( __DIR__.'/testdata/pxfw2-original/publish/px2/px-files/_sys/ram/caches/sitemaps/' ) );

		//↓realpathが記載されるため削除
		unlink( __DIR__.'/testdata/pxfw2-original/publish/published/php_error/notice.html' );
		unlink( __DIR__.'/testdata/pxfw2-original/publish/published/php_error/warning.html' );
	}
